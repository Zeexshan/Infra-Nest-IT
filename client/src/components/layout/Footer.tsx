        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
               ...
               <span className="text-xl font-bold font-heading">Infra Nest IT</span>
            </div>
            <p className="text-muted-foreground max-w-md mb-6">
              Transforming ideas into digital reality. We build scalable, modern, and robust 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#technologies" className="text-muted-foreground hover:text-primary transition-colors">Technologies</a></li>
